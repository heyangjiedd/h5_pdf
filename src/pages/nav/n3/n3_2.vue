<template>
  <div class="page">
    <HeaderBar :back="false" :isShow="!swiperC" :isFixed="false" right="2/3">阳光向上的我</HeaderBar>
    <div class="list">
...
<!--        <div class="right-star">-->
<!--          <img class="star" src="./../../../assets/img/g-star.png" alt="">-->
<!--          <span class="num">{{userInfo.totalBadge}}颗</span>-->
<!--        </div>-->
<!--      </div>-->
    </div>
  </div>
...
export default {
  ...
  methods:{
    ...
    ...mapActions('user',['getUserInfo','getSXM']),
    getData(){
      if(this.user){
        this.userInfo = this.user;
        this.getSXM({studentId:this.$route.query.id,year:this.year}).then(res => {
          if(res.code == 1){
            this.list = res.data.lianhuaStudentBadges;
          }
        })
      }
    },
